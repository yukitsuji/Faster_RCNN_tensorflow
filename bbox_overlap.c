...
#define __PYX_HAVE__bbox_overlap
#define __PYX_HAVE_API__bbox_overlap
#include <string.h>
#include <stdio.h>
#include <stdlib.h>
 ...
 * def bbox_overlaps(
 */
typedef __pyx_t_5numpy_float_t __pyx_t_12bbox_overlap_DTYPE_t;
/* Declarations.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'bbox_overlap' */
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_12bbox_overlap_DTYPE_t = { "DTYPE_t", NULL, sizeof(__pyx_t_12bbox_overlap_DTYPE_t), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "bbox_overlap"
int __pyx_module_is_main_bbox_overlap = 0;
...
static const char __pyx_k_home_katou01_code_Fast_RCNN_ten[] = "/home/katou01/code/Fast_RCNN_tensorflow/bbox_overlap.pyx";
...
static PyObject *__pyx_kp_s_home_katou01_code_Fast_RCNN_ten;
...
static PyObject *__pyx_pf_12bbox_overlap_bbox_overlaps(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_boxes, PyArrayObject *__pyx_v_query_boxes); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_12bbox_overlap_1bbox_overlaps(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_12bbox_overlap_bbox_overlaps[] = "\n    Parameters\n    ----------\n    boxes: (N, 4) ndarray of float\n    query_boxes: (K, 4) ndarray of float\n    Returns\n    -------\n    overlaps: (N, K) ndarray of overlap between boxes and query_boxes\n    ";
static PyMethodDef __pyx_mdef_12bbox_overlap_1bbox_overlaps = {"bbox_overlaps", (PyCFunction)__pyx_pw_12bbox_overlap_1bbox_overlaps, METH_VARARGS|METH_KEYWORDS, __pyx_doc_12bbox_overlap_bbox_overlaps};
static PyObject *__pyx_pw_12bbox_overlap_1bbox_overlaps(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("bbox_overlap.bbox_overlaps", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  __pyx_r = __pyx_pf_12bbox_overlap_bbox_overlaps(__pyx_self, __pyx_v_boxes, __pyx_v_query_boxes);
...
static PyObject *__pyx_pf_12bbox_overlap_bbox_overlaps(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_boxes, PyArrayObject *__pyx_v_query_boxes) {
  unsigned int __pyx_v_N;
  unsigned int __pyx_v_K;
  PyArrayObject *__pyx_v_overlaps = 0;
  __pyx_t_12bbox_overlap_DTYPE_t __pyx_v_iw;
  __pyx_t_12bbox_overlap_DTYPE_t __pyx_v_ih;
  __pyx_t_12bbox_overlap_DTYPE_t __pyx_v_box_area;
  __pyx_t_12bbox_overlap_DTYPE_t __pyx_v_ua;
  unsigned int __pyx_v_k;
  unsigned int __pyx_v_n;
  ...
  __pyx_t_12bbox_overlap_DTYPE_t __pyx_t_21;
  size_t __pyx_t_22;
  Py_ssize_t __pyx_t_23;
  __pyx_t_12bbox_overlap_DTYPE_t __pyx_t_24;
  __pyx_t_12bbox_overlap_DTYPE_t __pyx_t_25;
  size_t __pyx_t_26;
  Py_ssize_t __pyx_t_27;
  size_t __pyx_t_28;
  Py_ssize_t __pyx_t_29;
  __pyx_t_12bbox_overlap_DTYPE_t __pyx_t_30;
  int __pyx_t_31;
  size_t __pyx_t_32;
  ...
  __pyx_pybuffernd_query_boxes.rcbuffer = &__pyx_pybuffer_query_boxes;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_boxes.rcbuffer->pybuffer, (PyObject*)__pyx_v_boxes, &__Pyx_TypeInfo_nn___pyx_t_12bbox_overlap_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 15, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_query_boxes.rcbuffer->pybuffer, (PyObject*)__pyx_v_query_boxes, &__Pyx_TypeInfo_nn___pyx_t_12bbox_overlap_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 15, __pyx_L1_error)
  }
 ...
 */
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_overlaps.rcbuffer->pybuffer, (PyObject*)__pyx_t_5, &__Pyx_TypeInfo_nn___pyx_t_12bbox_overlap_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {
 ...
 *         )
 */
    __pyx_v_box_area = ((((*__Pyx_BufPtrStrided2d(__pyx_t_12bbox_overlap_DTYPE_t *, __pyx_pybuffernd_query_boxes.rcbuffer->pybuffer.buf, __pyx_t_8, __pyx_pybuffernd_query_boxes.diminfo[0].strides, __pyx_t_9, __pyx_pybuffernd_query_boxes.diminfo[1].strides)) - (*__Pyx_BufPtrStrided2d(__pyx_t_12bbox_overlap_DTYPE_t *, __pyx_pybuffernd_query_boxes.rcbuffer->pybuffer.buf, __pyx_t_11, __pyx_pybuffernd_query_boxes.diminfo[0].strides, __pyx_t_12, __pyx_pybuffernd_query_boxes.diminfo[1].strides))) + 1.0) * (((*__Pyx_BufPtrStrided2d(__pyx_t_12bbox_overlap_DTYPE_t *, __pyx_pybuffernd_query_boxes.rcbuffer->pybuffer.buf, __pyx_t_13, __pyx_pybuffernd_query_boxes.diminfo[0].strides, __pyx_t_14, __pyx_pybuffernd_query_boxes.diminfo[1].strides)) - (*__Pyx_BufPtrStrided2d(__pyx_t_12bbox_overlap_DTYPE_t *, __pyx_pybuffernd_query_boxes.rcbuffer->pybuffer.buf, __pyx_t_15, __pyx_pybuffernd_query_boxes.diminfo[0].strides, __pyx_t_16, __pyx_pybuffernd_query_boxes.diminfo[1].strides))) + 1.0));
 ...
 */
      ...
      __pyx_t_21 = (*__Pyx_BufPtrStrided2d(__pyx_t_12bbox_overlap_DTYPE_t *, __pyx_pybuffernd_query_boxes.rcbuffer->pybuffer.buf, __pyx_t_19, __pyx_pybuffernd_query_boxes.diminfo[0].strides, __pyx_t_20, __pyx_pybuffernd_query_boxes.diminfo[1].strides));
      ...
      __pyx_t_24 = (*__Pyx_BufPtrStrided2d(__pyx_t_12bbox_overlap_DTYPE_t *, __pyx_pybuffernd_boxes.rcbuffer->pybuffer.buf, __pyx_t_22, __pyx_pybuffernd_boxes.diminfo[0].strides, __pyx_t_23, __pyx_pybuffernd_boxes.diminfo[1].strides));
 ...
 */
      ...
      __pyx_t_21 = (*__Pyx_BufPtrStrided2d(__pyx_t_12bbox_overlap_DTYPE_t *, __pyx_pybuffernd_query_boxes.rcbuffer->pybuffer.buf, __pyx_t_26, __pyx_pybuffernd_query_boxes.diminfo[0].strides, __pyx_t_27, __pyx_pybuffernd_query_boxes.diminfo[1].strides));
      ...
      __pyx_t_24 = (*__Pyx_BufPtrStrided2d(__pyx_t_12bbox_overlap_DTYPE_t *, __pyx_pybuffernd_boxes.rcbuffer->pybuffer.buf, __pyx_t_28, __pyx_pybuffernd_boxes.diminfo[0].strides, __pyx_t_29, __pyx_pybuffernd_boxes.diminfo[1].strides));
      if (((__pyx_t_21 > __pyx_t_24) != 0)) {
 ...
 */
        ...
        __pyx_t_30 = (*__Pyx_BufPtrStrided2d(__pyx_t_12bbox_overlap_DTYPE_t *, __pyx_pybuffernd_query_boxes.rcbuffer->pybuffer.buf, __pyx_t_32, __pyx_pybuffernd_query_boxes.diminfo[0].strides, __pyx_t_33, __pyx_pybuffernd_query_boxes.diminfo[1].strides));
        ...
        __pyx_t_25 = (*__Pyx_BufPtrStrided2d(__pyx_t_12bbox_overlap_DTYPE_t *, __pyx_pybuffernd_boxes.rcbuffer->pybuffer.buf, __pyx_t_34, __pyx_pybuffernd_boxes.diminfo[0].strides, __pyx_t_35, __pyx_pybuffernd_boxes.diminfo[1].strides));
 ...
 */
        ...
        __pyx_t_30 = (*__Pyx_BufPtrStrided2d(__pyx_t_12bbox_overlap_DTYPE_t *, __pyx_pybuffernd_query_boxes.rcbuffer->pybuffer.buf, __pyx_t_36, __pyx_pybuffernd_query_boxes.diminfo[0].strides, __pyx_t_37, __pyx_pybuffernd_query_boxes.diminfo[1].strides));
        ...
        __pyx_t_25 = (*__Pyx_BufPtrStrided2d(__pyx_t_12bbox_overlap_DTYPE_t *, __pyx_pybuffernd_boxes.rcbuffer->pybuffer.buf, __pyx_t_38, __pyx_pybuffernd_boxes.diminfo[0].strides, __pyx_t_39, __pyx_pybuffernd_boxes.diminfo[1].strides));
        if (((__pyx_t_30 > __pyx_t_25) != 0)) {
 ...
 *                         (boxes[n, 3] - boxes[n, 1] + 1) +
 */
          __pyx_v_ua = ((double)((((((*__Pyx_BufPtrStrided2d(__pyx_t_12bbox_overlap_DTYPE_t *, __pyx_pybuffernd_boxes.rcbuffer->pybuffer.buf, __pyx_t_40, __pyx_pybuffernd_boxes.diminfo[0].strides, __pyx_t_41, __pyx_pybuffernd_boxes.diminfo[1].strides)) - (*__Pyx_BufPtrStrided2d(__pyx_t_12bbox_overlap_DTYPE_t *, __pyx_pybuffernd_boxes.rcbuffer->pybuffer.buf, __pyx_t_42, __pyx_pybuffernd_boxes.diminfo[0].strides, __pyx_t_43, __pyx_pybuffernd_boxes.diminfo[1].strides))) + 1.0) * (((*__Pyx_BufPtrStrided2d(__pyx_t_12bbox_overlap_DTYPE_t *, __pyx_pybuffernd_boxes.rcbuffer->pybuffer.buf, __pyx_t_44, __pyx_pybuffernd_boxes.diminfo[0].strides, __pyx_t_45, __pyx_pybuffernd_boxes.diminfo[1].strides)) - (*__Pyx_BufPtrStrided2d(__pyx_t_12bbox_overlap_DTYPE_t *, __pyx_pybuffernd_boxes.rcbuffer->pybuffer.buf, __pyx_t_46, __pyx_pybuffernd_boxes.diminfo[0].strides, __pyx_t_47, __pyx_pybuffernd_boxes.diminfo[1].strides))) + 1.0)) + __pyx_v_box_area) - (__pyx_v_iw * __pyx_v_ih)));
 ...
 */
          ...
          *__Pyx_BufPtrStrided2d(__pyx_t_12bbox_overlap_DTYPE_t *, __pyx_pybuffernd_overlaps.rcbuffer->pybuffer.buf, __pyx_t_48, __pyx_pybuffernd_overlaps.diminfo[0].strides, __pyx_t_49, __pyx_pybuffernd_overlaps.diminfo[1].strides) = (__pyx_t_24 / __pyx_v_ua);
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_home_katou01_code_Fast_RCNN_ten, __pyx_k_home_katou01_code_Fast_RCNN_ten, sizeof(__pyx_k_home_katou01_code_Fast_RCNN_ten), 0, 0, 1, 0},
 ...
 */
  ...
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(2, 0, 11, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_katou01_code_Fast_RCNN_ten, __pyx_n_s_bbox_overlaps, 15, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initbbox_overlap(void); /*proto*/
PyMODINIT_FUNC initbbox_overlap(void)
#else
PyMODINIT_FUNC PyInit_bbox_overlap(void); /*proto*/
PyMODINIT_FUNC PyInit_bbox_overlap(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_bbox_overlap(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("bbox_overlap", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_bbox_overlap) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "bbox_overlap")) {
      if (unlikely(PyDict_SetItemString(modules, "bbox_overlap", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *         np.ndarray[DTYPE_t, ndim=2] query_boxes):
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_12bbox_overlap_1bbox_overlaps, NULL, __pyx_n_s_bbox_overlap); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init bbox_overlap", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init bbox_overlap");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
